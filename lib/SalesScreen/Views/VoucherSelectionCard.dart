...
class VoucherSelectionCard extends StatelessWidget {
  final TextEditingController voucherCountController;
  final TextEditingController couponController = TextEditingController();

  VoucherSelectionCard({
    super.key,
    required this.voucherCountController,
  });
  ...
  int get voucherCount =>
      int.tryParse(voucherCountController.text) ?? 1;
              ...
              GestureDetector(
                onTap: () async {
                  ...
                  await previewController.getPreview(
                    cartItems: controller.cart!.items,
                    couponCode: coupon,
                    gstPercent: 5,
                  );
                  ...
                  Get.snackbar(
    "Success",
    coupon.isEmpty ? "Preview updated" : "Coupon Applied",
  );
                },
                child: Container(
                  height: 38.h,
