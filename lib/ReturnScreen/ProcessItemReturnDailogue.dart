...
class ProcessItemReturnDialog extends StatelessWidget {
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("SKU: $sku", style: TextStyle(fontSize: 11.sp)),
              ],
            ),
          ),
          Expanded(child: Text(qty)),
  ...
  Widget _sectionTitle(String step, String title) {
    return Padding(
      ...
      child: Row(
        children: [
          CircleAvatar(radius: 12.r, child: Text(step)),
          SizedBox(width: 10.w),
